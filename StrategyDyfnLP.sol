...
contract StrategyDyfnLP is StratManager, FeeManager {
    ...
    function chargeFees() internal {
        ...
        uint256 krillFeeAmount = wrappedBal.mul(krillFee).div(MAX_FEE);
        IERC20(wrapped).safeTransfer(krillFeeRecipient, krillFeeAmount);
